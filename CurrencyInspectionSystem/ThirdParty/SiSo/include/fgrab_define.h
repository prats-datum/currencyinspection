...
enum FgProperty{
	...
	PROP_ID_MIN           = 10, /**< request the parameter id for min parameter*/
	PROP_ID_MAX           = 11, /**< request the parameter id for max parameter*/
	PROP_ID_STEP          = 12, /**< request the parameter id for step parameter*/
};
 ...
 */
#define FG_POCL_CONNECTION_SENSE 				1 	/**< Power over CL : detection in progress */
#define FG_POCL_CAMERA_AND_CABLE_DETECTED 		2   /**< Power over CL : camera and cable are OK */
#define FG_POCL_CAMERA_CLOCK_DETECTED 			3   /**< Power over CL : a pixel clock is detected */
#define FG_POCL_CAMERA_OR_CABLE_NOT_DETECTED 	4   /**< Power over CL : no cable or camera detected */
#define FG_POCL_CAMERA_CLOCK_NOT_DETECTED 		5   /**< Power over CL : no pixel clock is detected */
