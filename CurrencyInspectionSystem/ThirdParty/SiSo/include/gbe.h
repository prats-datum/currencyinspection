...
#define GBE_BOARDPROP_START_CABLEDIAGNOSTIC0 "startCableDiagnostic0"	/** start cable diagnostic for port 0 (if supported) [writeonly] */
#define GBE_BOARDPROP_START_CABLEDIAGNOSTIC1 "startCableDiagnostic1"	/** start cable diagnostic for port 1 (if supported) [writeonly] */
#define GBE_BOARDPROP_START_CABLEDIAGNOSTIC2 "startCableDiagnostic2"	/** start cable diagnostic for port 2 (if supported) [writeonly] */
#define GBE_BOARDPROP_START_CABLEDIAGNOSTIC3 "startCableDiagnostic3"	/** start cable diagnostic for port 3 (if supported) [writeonly] */

#define GBE_BOARDPROP_POE0                  "poe0"                      /** POE state of port 0 (if supported) [in/out] (uint16) */
#define GBE_BOARDPROP_POE1                  "poe1"                      /** POE state of port 1 (if supported) [in/out] (uint16) */
#define GBE_BOARDPROP_POE2                  "poe2"                      /** POE state of port 2 (if supported) [in/out] (uint16) */
#define GBE_BOARDPROP_POE3                  "poe3"                      /** POE state of port 3 (if supported) [in/out] (uint16) */

#define GBE_BOARDPROP_LINKSTATE0            "linkState0"                /** Link state of port 0 (if supported) [out] */
#define GBE_BOARDPROP_LINKSTATE1            "linkState1"                /** Link state of port 1 (if supported) [out] */
#define GBE_BOARDPROP_LINKSTATE2            "linkState2"                /** Link state of port 2 (if supported) [out] */
#define GBE_BOARDPROP_LINKSTATE3            "linkState3"                /** Link state of port 3 (if supported) [out] */

#define GBE_BOARDPROP_CONNECTIONSTATE0      "connectionState0"          /** Connection state of port 0 (if supported) [out] (uint32) */
#define GBE_BOARDPROP_CONNECTIONSTATE1      "connectionState1"          /** Connection state of port 1 (if supported) [out] (uint32) */
#define GBE_BOARDPROP_CONNECTIONSTATE2      "connectionState2"          /** Connection state of port 2 (if supported) [out] (uint32) */
#define GBE_BOARDPROP_CONNECTIONSTATE3      "connectionState3"          /** Connection state of port 3 (if supported) [out] (uint32) */

#define GBE_BOARDPROP_RXERCOUNT0            "rxerCount0"                /** RXER count of port 0 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_RXERCOUNT1            "rxerCount1"                /** RXER count of port 1 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_RXERCOUNT2            "rxerCount2"                /** RXER count of port 2 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_RXERCOUNT3            "rxerCount3"                /** RXER count of port 3 (if supported) [out] (uint16) */

#define GBE_BOARDPROP_IDLEERRORCOUNT0       "idleErrorCount0"           /** Idle error count of port 0 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_IDLEERRORCOUNT1       "idleErrorCount1"           /** Idle error count of port 1 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_IDLEERRORCOUNT2       "idleErrorCount2"           /** Idle error count of port 2 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_IDLEERRORCOUNT3       "idleErrorCount3"           /** Idle error count of port 3 (if supported) [out] (uint16) */

#define GBE_BOARDPROP_FAULTFLAGS0           "faultFlags0"               /** Fault flags of port 0 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_FAULTFLAGS1           "faultFlags1"               /** Fault flags of port 1 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_FAULTFLAGS2           "faultFlags2"               /** Fault flags of port 2 (if supported) [out] (uint16) */
#define GBE_BOARDPROP_FAULTFLAGS3           "faultFlags3"               /** Fault flags of port 3 (if supported) [out] (uint16) */
...
#define GBE_CAMPROP_FWAC_DEVICEKEY          "fwacDeviceKey"             /** set/get firmware action device key (if supported) [in/out] */
#define GBE_CAMPROP_FWAC_GROUPKEY           "fwacGroupKey"              /** set/get firmware action group key (if supported) [in/out] */
#define GBE_CAMPROP_FWAC_GROUPMASK          "fwacGroupMask"             /** set/get firmware action group mask (if supported) [in/out] */

#define GBE_CAMPROP_EXTENDED_ID             "extendedId"                /** set/get extended ID mode (if supported) [in/out] */
...
struct GbeEventInfo
{
	...
	union {
        ...
        struct {
            ...
            /** the cable diagnostic result (0 = OK, 1 = Open Cable Fault, 2 = Short Cable Fault, 4 = Timeout) (GBE_EVENT_CABLEDIAGNOSTIC_STATUS) */
            uint16_t result;
            /** the cable diagnostic distance to cable fault (GBE_EVENT_CABLEDIAGNOSTIC_STATUS) */
