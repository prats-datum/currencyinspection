...
public:
	...
	COLORREF GetGraphSubaxistitleColor();
	COLORREF GetGraphaxistitleColor();
	void SetGraphSubaxistitleColor( COLORREF s_color );
	void SetGraphaxistitleColor( COLORREF t_color );
...
private:
	BOOL m_ShowLegend;
	COLORREF m_GraphSubaxistitleColor;
	COLORREF m_GraphaxistitleColor;
